...
//add a record
module.exports.addRecord = async (categoryId, amount, description, createdOn, userId) => {
...
//update a record
module.exports.updateRecord = async (recordId, categoryId, amount, description, createdOn) => {   
    const updates = {}
